...
@router.get(
    "/tasks", response_model=List[ResponseTaskEntity], tags=["Tasks"], dependencies=[Depends(get_current_client)]
)
...
@router.put(
    "/tasks/{task_id}", response_model=ResponseTaskEntity, tags=["Tasks"], dependencies=[Depends(get_current_client)]
)
...
@router.get(
    ...
    response_model=ResponseTaskEntity,
    tags=["Tasks"],
